...
{
    public class Level2 : SceneState
    {
        // data
        ...
        public override void Initialize()
        {
            ...
            pWallRight.ActivateGameSprite(pSB_Aliens);
            ...
            pGameObject = factory.Create(GameObject.Name.SquidA, Alien.Type.Squid, 50.0f, 650.0f);
            pCol1.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 50.0f, 600.0f);
            pCol1.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 50.0f, 550.0f);
            pCol1.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 50.0f, 500.0f);
            pCol1.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 50.0f, 450.0f);
            pCol1.Add(pGameObject);
            ...
            pGameObject = factory.Create(GameObject.Name.SquidA, Alien.Type.Squid, 100.0f, 650.0f);
            pCol2.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 100.0f, 600.0f);
            pCol2.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 100.0f, 550.0f);
            pCol2.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 100.0f, 500.0f);
            pCol2.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 100.0f, 450.0f);
            pCol2.Add(pGameObject);
            ...
            pGameObject = factory.Create(GameObject.Name.SquidA, Alien.Type.Squid, 150.0f, 650.0f);
            pCol3.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 150.0f, 600.0f);
            pCol3.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 150.0f, 550.0f);
            pCol3.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 150.0f, 500.0f);
            pCol3.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 150.0f, 450.0f);
            pCol3.Add(pGameObject);
            ...
            pGameObject = factory.Create(GameObject.Name.SquidA, Alien.Type.Squid, 200, 650.0f);
            pCol4.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 200.0f, 600.0f);
            pCol4.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 200.0f, 550.0f);
            pCol4.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 200.0f, 500.0f);
            pCol4.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 200.0f, 450.0f);
            pCol4.Add(pGameObject);
            ...
            pGameObject = factory.Create(GameObject.Name.SquidA, Alien.Type.Squid, 250.0f, 650.0f);
            pCol5.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 250.0f, 600.0f);
            pCol5.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 250.0f, 550.0f);
            pCol5.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 250.0f, 500.0f);
            pCol5.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 250.0f, 450.0f);
            pCol5.Add(pGameObject);
            ...
            pGameObject = factory.Create(GameObject.Name.SquidA, Alien.Type.Squid, 300.0f, 650.0f);
            pCol6.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 300.0f, 600.0f);
            pCol6.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 300.0f, 550.0f);
            pCol6.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 300.0f, 500.0f);
            pCol6.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 300.0f, 450.0f);
            pCol6.Add(pGameObject);
            ...
            pGameObject = factory.Create(GameObject.Name.SquidA, Alien.Type.Squid, 350.0f, 650.0f);
            pCol7.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 350.0f, 600.0f);
            pCol7.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 350.0f, 550.0f);
            pCol7.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 350.0f, 500.0f);
            pCol7.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 350.0f, 450.0f);
            pCol7.Add(pGameObject);
            ...
            pGameObject = factory.Create(GameObject.Name.SquidA, Alien.Type.Squid, 400.0f, 650.0f);
            pCol8.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 400.0f, 600.0f);
            pCol8.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 400.0f, 550.0f);
            pCol8.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 400.0f, 500.0f);
            pCol8.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 400.0f, 450.0f);
            pCol8.Add(pGameObject);
            ...
            pGameObject = factory.Create(GameObject.Name.SquidA, Alien.Type.Squid, 450.0f, 650.0f);
            pCol9.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 450.0f, 600.0f);
            pCol9.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 450.0f, 550.0f);
            pCol9.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 450.0f, 500.0f);
            pCol9.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 450.0f, 450.0f);
            pCol9.Add(pGameObject);
            ...
            pGameObject = factory.Create(GameObject.Name.SquidA, Alien.Type.Squid, 500.0f, 650.0f);
            pCol10.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 500.0f, 600.0f);
            pCol10.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 500.0f, 550.0f);
            pCol10.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 500.0f, 500.0f);
            pCol10.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 500.0f, 450.0f);
            pCol10.Add(pGameObject);
            ...
            pGameObject = factory.Create(GameObject.Name.SquidA, Alien.Type.Squid, 550.0f, 650.0f);
            pCol11.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 550.0f, 600.0f);
            pCol11.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.AlienA, Alien.Type.Crab, 550.0f, 550.0f);
            pCol11.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 550.0f, 500.0f);
            pCol11.Add(pGameObject);

            pGameObject = factory.Create(GameObject.Name.OctopusA, Alien.Type.Octopus, 550.0f, 450.0f);
            pCol11.Add(pGameObject);
            ...
            MovementSprite pMovementSprite = new MovementSprite(pGrid, 2);
            TimerManager.Add(TimeEvent.Name.SpriteMovement, pMovementSprite, 0.9f);

            // UFO stuff
            UFOTimer pUFOTimer = new UFOTimer(pUFOLeft, 2);
            ...
            TimerManager.Add(TimeEvent.Name.SpriteAnimation, pSquidAnim, 0.9f);
            ...
            TimerManager.Add(TimeEvent.Name.SpriteAnimation, pCrabAnim, 0.9f);
            ...
            TimerManager.Add(TimeEvent.Name.SpriteAnimation, pOctoAnim, 0.9f);
            ...
            TextManager.Add(TextFont.Name.PlayerScore, SpriteBatch.Name.Texts,GameStats.GetScore().ToString(), Glyph.Name.Consolas20pt, 25, 1000);

            TextManager.Add(TextFont.Name.HighScoreHeader, SpriteBatch.Name.Texts, "<Hi-Score>", Glyph.Name.Consolas20pt, 250, 1030);
            TextManager.Add(TextFont.Name.HighScore, SpriteBatch.Name.Texts, GameStats.GetScore().ToString(), Glyph.Name.Consolas20pt, 290, 1000);
